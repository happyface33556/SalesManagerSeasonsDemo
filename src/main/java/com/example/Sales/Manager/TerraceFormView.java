...
@Route("TerraceForm")
@Tag("terrace-view")
@JsModule("./src/views/terrace-view.js")
public class TerraceFormView extends PolymerTemplate<TemplateModel> {
    @Id("header")
    Div header;
    ...
    public TerraceFormView(InquiryRepo repo) {
        createHeader();
        ...
        numGuests.setPlaceholder("No more than 80");
